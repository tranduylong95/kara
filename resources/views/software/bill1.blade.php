...
<p><table border="1" style="width:100%;border-collapse:collapse;  " class="thanhtoan">
                    ...
                    <tbody>
                        ...
                        <tr><td style="text-align:left;"colspan="5"> <span style="font-size: 11px;">Tiền giờ ({{date_format(new DateTime($value->time_start),"H:i")}}-><?php if($value->time_finish) {echo new DateTime($value->time_finish,"H:i");} else { echo date_create('now')->format('H:i'); };?>)</span></td></tr>
                          <tr>
                            ...
                            <td style="text-align: center;font-size: 11px; " class="number1">
                              <?php
                                   ...
                                   echo round($a/60);}
                                     ...
                                     $a=strtotime(date_create('now')->format('Y-m-d H:i:s'))-strtotime($value->time_start);
                                   echo round($a/60);
                                   }
                               ?>
